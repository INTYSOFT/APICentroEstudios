...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    public class EmpaquesController : ControllerBase
    {
        ...
        public EmpaquesController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        // GET: api/LgEmpaques
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Empaque>>> GetLgEmpaque()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Empaque>> GetLgEmpaque(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgEmpaque(int id, Empaque lgEmpaque)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Empaque>> PostLgEmpaque(Empaque lgEmpaque)
        {
