...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    public class ModeloesController : ControllerBase
    {
        ...
        public ModeloesController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        // GET: api/LgModeloes
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Modelo>>> GetLgModelo()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Modelo>> GetLgModelo(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgModelo(int id, Modelo lgModelo)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Modelo>> PostLgModelo(Modelo lgModelo)
        {
