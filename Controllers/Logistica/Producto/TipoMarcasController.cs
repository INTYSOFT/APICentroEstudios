...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    public class TipoMarcasController : ControllerBase
    {
        ...
        public TipoMarcasController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TipoMarca>>> GetLgTipoMarca()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<TipoMarca>> GetLgTipoMarca(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgTipoMarca(int id, TipoMarca lgTipoMarca)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<TipoMarca>> PostLgTipoMarca(TipoMarca lgTipoMarca)
        {
