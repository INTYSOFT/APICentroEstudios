...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    public class TipoProductoesController : ControllerBase
    {
        ...
        public TipoProductoesController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TipoProductos>>> GetLgTipoProducto()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<TipoProductos>> GetLgTipoProducto(short id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgTipoProducto(short id, TipoProductos lgTipoProducto)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<TipoProductos>> PostLgTipoProducto(TipoProductos lgTipoProducto)
        {
