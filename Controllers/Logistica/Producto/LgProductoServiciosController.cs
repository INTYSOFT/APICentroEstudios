...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    [ApiController]
    public class LgProductoServiciosController : ControllerBase
    {
        private readonly ConecDinamicaContext _context;

        public LgProductoServiciosController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<LgProductoServicio>>> GetLgProductoServicio()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<LgProductoServicio>> GetLgProductoServicio(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgProductoServicio(int id, LgProductoServicio lgProductoServicio)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<LgProductoServicio>> PostLgProductoServicio(LgProductoServicio lgProductoServicio)
        {
