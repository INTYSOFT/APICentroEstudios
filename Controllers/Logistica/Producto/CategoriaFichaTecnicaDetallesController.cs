...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    [ApiController]
    public class CategoriaFichaTecnicaDetallesController : ControllerBase
    {
        private readonly ConecDinamicaContext _context;

        public CategoriaFichaTecnicaDetallesController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CategoriaFichaTecnicaDetalle>>> GetLgCategoriaFichaTecnicaDetalle()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<CategoriaFichaTecnicaDetalle>> GetLgCategoriaFichaTecnicaDetalle(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgCategoriaFichaTecnicaDetalle(int id, CategoriaFichaTecnicaDetalle lgCategoriaFichaTecnicaDetalle)
        {
        ...
        public async Task<ActionResult<IEnumerable<CategoriaFichaTecnicaDetalle>>> GetByCategoriaFichaTecnicaId(int id)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<CategoriaFichaTecnicaDetalle>> PostLgCategoriaFichaTecnicaDetalle(CategoriaFichaTecnicaDetalle lgCategoriaFichaTecnicaDetalle)
        {
        ...
        //patch
        [HttpPatch("{id}")]
        public async Task<ActionResult<CategoriaFichaTecnicaDetalle>> Patch(int id, [FromBody] JsonPatchDocument<CategoriaFichaTecnicaDetalle> patch)
        {
            if (patch == null)
            {
                return BadRequest();
