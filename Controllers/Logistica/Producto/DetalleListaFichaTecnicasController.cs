...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    [ApiController]
    public class DetalleListaFichaTecnicasController : ControllerBase
    {
        private readonly ConecDinamicaContext _context;

        public DetalleListaFichaTecnicasController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DetalleListaFichaTecnica>>> GetLgDetalleListaFichaTecnica()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<DetalleListaFichaTecnica>> GetLgDetalleListaFichaTecnica(int id)
        {
        ...
        public async Task<ActionResult<IEnumerable<DetalleListaFichaTecnica>>> GetLgDetalleListaFichaTecnicaByListaFichaTecnicaId(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgDetalleListaFichaTecnica(int id, DetalleListaFichaTecnica lgDetalleListaFichaTecnica)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<DetalleListaFichaTecnica>> PostLgDetalleListaFichaTecnica(DetalleListaFichaTecnica lgDetalleListaFichaTecnica)
        {
