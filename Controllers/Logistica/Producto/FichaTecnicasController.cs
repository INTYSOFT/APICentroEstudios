...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    public class FichaTecnicasController : ControllerBase
    {
        ...
        public FichaTecnicasController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<FichaTecnica>>> GetLgFichaTecnica()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<FichaTecnica>> GetLgFichaTecnica(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgFichaTecnica(int id, FichaTecnica lgFichaTecnica)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<FichaTecnica>> PostLgFichaTecnica(FichaTecnica lgFichaTecnica)
        {
