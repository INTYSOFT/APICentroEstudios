...
namespace api_intiSoft.Controllers.Logistica.Producto
{
    ...
    public class UnidadMedidumsController : ControllerBase
    {
        ...
        public UnidadMedidumsController(ConecDinamicaContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UnidadMedidum>>> GetLgUnidadMedidum()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<UnidadMedidum>> GetLgUnidadMedidum(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLgUnidadMedidum(int id, UnidadMedidum lgUnidadMedidum)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<UnidadMedidum>> PostLgUnidadMedidum(UnidadMedidum lgUnidadMedidum)
        {
